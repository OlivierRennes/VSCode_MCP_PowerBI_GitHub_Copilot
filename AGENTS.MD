...
- **TMDL Docs**: Power BI Tabular Model Definition Language (PBIP format)
- **DAX Best Practices**: sqlbi.com, dax.guide
- **Power Query**: Microsoft docs, query folding patterns
- **Aggregations Guide**: Composite models, design patterns
- **Performance Analyzer**: DAX timing, query plans
- **Compatibility Levels**: 1465, 1500, 1550, 1600, 1700 features

## 🚀 Installation dans VS Code

1. Copier cet agent `.instructions.md`
2. VS Code → Copilot Chat → Settings ⚙️
3. **Create Custom Agent** → `pbip-analyzer`
4. Coller ce contenu
5. Sauvegarder

**Usage**: `/pbip-analyzer` dans Copilot Chat
